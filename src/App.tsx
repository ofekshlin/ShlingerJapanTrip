  ...
  itinerary: [
      ...
      events: [
        {
          time: "15:35",
          title: "נחיתה בטוקיו",
          desc: "נחיתה בשדה התעופה Narita, רכבת Skyliner לתחנת Ueno ומונית למלון.",
          icon: <Plane size={16} />,
        },
        {
          time: "18:00",
          title: "צ'ק אין למלון",
          desc: "Richmond Hotel Asakusa",
          icon: <MapPin size={16} />,
        },
        {
          time: "19:30",
          title: "ערב באזור Asakusa",
          desc: "טיול ברחוב Kannon ורחוב Orange. ארוחת ערב באחת הסמטאות הציוריות.",
      ...
      events: [
        {
          time: "10:00",
          title: "Tokyo Skytree",
          desc: "המגדל הגבוה ביפן, תצפית ומתחם קניות (אופציה לאקווריום ופלנטריום).",
          icon: <Camera size={16} />,
        },
        {
          time: "13:00",
          title: "אזור Asakusa ומקדש Senso-ji",
          desc: "שער Kaminari-mon, רחוב הקניות Nakamise (ממתקי Wagashi) ומקדש Senso-ji.",
          icon: <MapPin size={16} />,
        },
        {
          time: "15:30",
          title: "שייט מאודאיבה",
          desc: "מעבורת Tokyo Cruise Ship לאי המלאכותי Odaiba.",
          icon: <Compass size={16} />,
        },
        {
          time: "16:30",
          title: "Odaiba",
          desc: "טיילת, פסל החירות, ורובוט Unicorn Gundam. אופציה למוזיאון Miraikan או Joypolis.",
          icon: <Camera size={16} />,
        },
        {
          time: "19:00",
          title: "teamLab Planets",
          desc: "חוויה וירטואלית עוצרת נשימה של אור ומגע (יש להזמין כרטיסים).",
          icon: <Camera size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          ...
          desc: "ארוחת בוקר של סושי וסשימי, דוכני וואגיו ועוד. (פתוח 5:00-14:00)",
          icon: <Utensils size={16} />,
        },
        {
          time: "11:00",
          title: "קניות באזור Ginza",
          desc: "רחוב Chuo-dori. קניונים: GINZA SIX, Tokyu Plaza, Mitsukoshi, יוניקלו 12 קומות.",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "15:00",
          title: "Art Aquarium",
          desc: "תערוכת אקווריומים אומנותית (הפסקה מהקניות).",
          icon: <Camera size={16} />,
        },
        {
          time: "18:00",
          title: "ערב ב-Yurakucho Gado-shita",
          desc: "איזאקיות ומסעדות יפניות אותנטיות מתחת לפסי הרכבת.",
          icon: <Utensils size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          time: "10:00",
          title: "פארק Ueno",
          desc: "אגם Shinobazu, מוזיאונים (טבע, אומנות), ופסל הסמוראי האחרון.",
          icon: <MapPin size={16} />,
        },
        {
          time: "13:00",
          title: "שוק Ameyoko",
          desc: "שוק תוסס עם בגדים, אוכל רחוב ומזכרות.",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "15:30",
          title: "Akihabara",
          desc: "עיר החשמל! משחקיות, חנויות אנימה. אופציה לבתי קפה של חיות (Owl Cafe, Cat Cafe) או Maidcafe.",
          icon: <Coffee size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          time: "08:30",
          title: "נסיעה להאקונה",
          desc: "שליחת מזוודות קדימה. מונית לתחנת טוקיו -> שינקנסן ל-Odawara.",
          icon: <Plane size={16} />,
        },
        {
          time: "10:30",
          title: "Hakone-Yumoto",
          desc: "העיירה הדרומית. משם רכבת נופית Tozan לתחנת Gora.",
          icon: <MapPin size={16} />,
        },
        {
          time: "12:30",
          title: "עמק Owakudani",
          desc: "רכבל ללוע הר הגעש. טעימת ביצים שחורות.",
          icon: <Utensils size={16} />,
        },
        {
          time: "14:30",
          title: "אגם אשי ושייט",
          desc: "רכבל לאגם אשי ושייט בספינת פיראטים.",
          icon: <Compass size={16} />,
        },
        {
          time: "16:00",
          title: "מקדש Hakone",
          desc: "שער הטורי הצף על המים.",
          icon: <Camera size={16} />,
        },
        {
          time: "18:00",
          title: "הגעה למלון",
          desc: "מלון Hakone Ashinoko Hanaori על שפת האגם. ארוחת ערב ואונסן.",
          icon: <MapPin size={16} />,
        },
      ],
    },
    {
      ...
      events: [
        {
          time: "09:30",
          title: "המוזיאון הפתוח (Hakone)",
          desc: "פיסול וטבע, כולל מתחם פיקאסו.",
          icon: <Camera size={16} />,
        },
        {
          time: "13:00",
          title: "נסיעה לקיוטו",
          desc: "רכבת ל-Odawara ומשם שינקנסן לקיוטו. צ'ק אין ב-Cross Hotel.",
          icon: <Plane size={16} />,
        },
        {
          time: "16:00",
          title: "שוק האוכל Nishiki",
          desc: "דאונטאון קיוטו (Kawaramachi). שוק אוכל עתיק, מאות דוכנים.",
          icon: <Utensils size={16} />,
        },
        {
          time: "19:00",
          title: "רחוב Kiyamachi-dori",
          desc: "סמטה לאורך תעלה עם מסעדות ובארים לארוחת ערב.",
          icon: <Utensils size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          ...
          desc: "אחד המקדשים היפים ביפן המצופה זהב.",
          icon: <Camera size={16} />,
        },
        {
          time: "11:00",
          title: "נסיעה ל-Arashiyama",
          desc: "רכבת רטרו לתחנת אראשייאמה.",
          icon: <MapPin size={16} />,
        },
        {
          time: "12:00",
          title: "פארק הקופים",
          desc: "מעבר גשר Togetsukyo ועלייה לפארק הקופים איוואטאיאמה.",
          icon: <Camera size={16} />,
        },
        {
          time: "14:30",
          title: "רכבת נוף Sagano",
          desc: "נסיעה איטית על צד הנהר (אופציה לשייט חזרה).",
          icon: <Compass size={16} />,
        },
        {
          time: "16:30",
          title: "יער הבמבוק",
          desc: 'שעות אחה"צ הן הטובות ביותר לתאורה ביער.',
          icon: <Camera size={16} />,
        },
        {
          time: "19:30",
          title: "סמטת Pontocho",
          desc: "ארוחת ערב בסמטה צרה ומסורתית.",
          icon: <Utensils size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          ...
          desc: "לבישת קימונו וטקס תה מסורתי. סיור ברחוב Hanamikoji.",
          icon: <Coffee size={16} />,
        },
        {
          time: "13:00",
          title: "מקדש Kodaiji",
          desc: "גנים מרשימים ויער במבוק קטן.",
          icon: <MapPin size={16} />,
        },
        {
          time: "14:30",
          title: "רחוב Ninenzaka ומקדש Kiyomizu-dera",
          desc: "עלייה דרך רחובות עתיקים. המקדש משקיף על כל קיוטו.",
          icon: <Camera size={16} />,
        },
        {
          time: "18:00",
          title: "מקדש Yasaka / Maruyama",
          desc: "לקראת שקיעה, הפארק מואר באלפי עששיות.",
          icon: <Camera size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          ...
          desc: "רכבת ל-Kurama וקרונית הר לראש המסלול.",
          icon: <Compass size={16} />,
        },
        {
          time: "10:30",
          title: "מסלול הליכה ביער",
          desc: "מסלול של שעה וחצי דרך מקדשים עתיקים (Teimei, Tsuzura-ori).",
          icon: <MapPin size={16} />,
        },
        {
          time: "13:00",
          title: "עיירת Kibune",
          desc: 'עיירה על הנהר. ארוחת צהריים - "אטריות מתגלשות" בבמבוק.',
          icon: <Utensils size={16} />,
        },
        {
          time: "18:00",
          title: "מקדש Kifune",
          desc: "מואר בעששיות בשעות הדמדומים.",
          icon: <Camera size={16} />,
        },
      ],
    },
    {
      ...
      events: [
        {
          time: "07:30",
          title: "Fushimi Inari (קיוטו)",
          desc: "הגעה מוקדמת כדי להימנע מעומס. מנהרת שערי הטורי המפורסמת.",
          icon: <Camera size={16} />,
        },
        {
          time: "11:00",
          title: "Nara",
          desc: "נסיעה לנארה. ביקור בפארק האיילים והמקדשים. מופע הכנת מוצ'י בחנות Nakatanidou.",
          icon: <MapPin size={16} />,
        },
        {
          time: "15:00",
          title: "הגעה לאוסקה",
          desc: "נסיעה ל-Namba, צ'ק אין ב-Cross Hotel Osaka.",
          icon: <Plane size={16} />,
        },
        {
          time: "17:00",
          title: "Shinsaibashi & Dotonbori",
          desc: "רחובות קניות תוססים. תמונה עם איש הגליקו.",
          icon: <ShoppingBag size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          ...
          desc: "ארוחת בוקר וטעימות מהמטבח האוסקאי.",
          icon: <Utensils size={16} />,
        },
        {
          time: "12:00",
          title: "Shinsaibashi",
          desc: "זמן חופשי לשופינג במדרחוב המרכזי.",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "17:00",
          title: "Shinsekai district",
          desc: "רובע רטרו (שנות ה-50). שיפודי Kushikatsu לארוחת ערב.",
          icon: <Utensils size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          time: "10:00",
          title: "מגדל Umeda",
          desc: "תצפית מרהיבה על העיר.",
          icon: <Camera size={16} />,
        },
        {
          time: "12:30",
          title: "Den-Den Town",
          desc: "עיר האנימה של אוסקה (דומה לאקיהברה).",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "15:00",
          title: "Namba Parks",
          desc: "קניון ייחודי המשולב עם טבע וצמחייה.",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "17:00",
          title: "מופע Sumo",
          desc: "Hirakuza Osaka - מופע סומו חוויתי קרוב לטבעת.",
          icon: <MapPin size={16} />,
        },
        {
          time: "20:30",
          title: "Amerikamura",
          desc: "מרכז צעירים אופנתי לארוחת ערב.",
          icon: <Utensils size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          time: "09:00",
          title: "חזרה לטוקיו",
          desc: "שליחת מזוודות יום לפני. שינקנסן מאוסקה לטוקיו.",
          icon: <Plane size={16} />,
        },
        {
          time: "13:00",
          title: "צ'ק אין",
          desc: "הגעה ל-Shibuya Stream Hotel.",
          icon: <MapPin size={16} />,
        },
        {
          time: "15:00",
          title: "מגדל טוקיו",
          desc: "סיור באזור המגדל (דמוי מגדל אייפל).",
          icon: <Camera size={16} />,
        },
        {
          time: "16:30",
          title: "Azabu-Juban & Roppongi",
          desc: "שכונות יוקרתיות. Roppongi Hills תצפית ומוזיאון Mori.",
          icon: <MapPin size={16} />,
        },
        {
          time: "19:30",
          title: "ארוחת ערב Gonpachi",
          desc: 'המסעדה האייקונית מהסרט "קיל ביל" ב-Nishi-Azabu.',
          icon: <Utensils size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          ...
          desc: "מעבר החציה העמוס בעולם ופסל הכלב האצ'יקו.",
          icon: <Camera size={16} />,
        },
        {
          time: "11:00",
          title: "Shibuya Center-Gai",
          desc: "רחובות קניות, חנות הדגל של Don Quijote, ZARA ועוד.",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "14:00",
          title: "Miyashita Park",
          desc: "פארק תלוי על גג קניון.",
          icon: <MapPin size={16} />,
        },
        {
          time: "15:30",
          title: "שכונת Daikanyama",
          desc: "שכונה שיקית וסטייליסטית, מתחם T-SITE ו-Log Road.",
          icon: <Coffee size={16} />,
        },
        {
          time: "19:00",
          title: "ערב בשיבויה",
          desc: "בילוי באיזאקיות ומסעדות בקומות העליונות של שיבויה.",
          icon: <Utensils size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          time: "08:00",
          title: "נסיעה לקמקורה",
          desc: "רכבת ל-Hase Station.",
          icon: <Plane size={16} />,
        },
        {
          time: "10:00",
          title: "הבודהה הגדול",
          desc: "פסל ברונזה ענק משנת 1252 במקדש Kotoku-in.",
          icon: <Camera size={16} />,
        },
        {
          time: "11:30",
          title: "מקדש Hasedera",
          desc: "גנים יפים, פסלים מחייכים ונוף למפרץ.",
          icon: <MapPin size={16} />,
        },
        {
          time: "13:00",
          title: "רחוב Komachidori",
          desc: "ארוחת צהריים ומזכרות. משם למקדש Tsurugaoka.",
          icon: <Utensils size={16} />,
        },
        {
          time: "15:30",
          title: "Enoshima",
          desc: "נסיעה בחשמלית Enoden לאי אנושימה. מקדשים ונוף מרהיב.",
          icon: <Compass size={16} />,
        },
        {
          time: "18:00",
          title: "Enoshima Sea Candle",
          desc: "תצפית שקיעה מגובה המגדל.",
          icon: <Camera size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          ...
          desc: "ריאה ירוקה ענקית. הליכה ביער למקדש הקיסר.",
          icon: <MapPin size={16} />,
        },
        {
          time: "12:00",
          title: "Harajuku",
          desc: "רחוב Takeshita הצבעוני. ממתקים, אופנה ובתי קפה של חיות.",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "14:30",
          title: "Omotesando",
          desc: "השאנז אליזה של טוקיו. מותגי יוקרה וקניונים מעוצבים.",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "16:00",
          title: "Cat Street",
          desc: "מדרחוב מלא סטייל שמוביל עד לשיבויה.",
          icon: <Coffee size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          time: "10:00",
          title: "Shinjuku",
          desc: "התחנה העמוסה בעולם. תצפית חינמית מ-Metropolitan building.",
          icon: <Camera size={16} />,
        },
        {
          time: "12:30",
          title: "פארק Shinjuku Gyoen",
          desc: "הגן הלאומי המרהיב של טוקיו.",
          icon: <MapPin size={16} />,
        },
        {
          time: "15:00",
          title: "Yoyogi Broadway",
          desc: "מתחם ניו יורקי עם גלריות ומסעדות.",
          icon: <Utensils size={16} />,
        },
        {
          time: "17:00",
          title: "שלט החתול ו-Omoide Yokocho",
          desc: "תל מימד של חתול וסמטת שיפודי יאקיטורי.",
          icon: <Utensils size={16} />,
        },
        {
          time: "19:30",
          title: "Kabukicho",
          desc: "רובע הבילויים, שלטי ניאון ופסל הגוזילה.",
          icon: <MapPin size={16} />,
        },
      ],
    },
      ...
      events: [
        {
          time: "10:00",
          title: "השלמת קניות",
          desc: "זמן חופשי בשיבויה, האראג'וקו או גינזה.",
          icon: <ShoppingBag size={16} />,
        },
        {
          time: "14:00",
          title: "יציאה לשדה",
          desc: "איסוף מזוודות ורכבת Narita Express לשדה התעופה.",
          icon: <Plane size={16} />,
        },
      ],
    },
...
export default function JapanTripApp() {
  ...
  return (
    <div
      dir="rtl"
      className="w-full max-w-md mx-auto bg-[#FDF8EE] min-h-screen relative font-sans text-gray-800 shadow-xl overflow-hidden flex flex-col"
    >
      {/* Header */}
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-[#FAF3E0] rounded-3xl p-8 text-center shadow-sm mb-8">
        <h2 className="text-3xl font-bold mb-4 text-[#5D554D]">
          יפן מחכה לנו!
        </h2>
        ...
        <p className="text-gray-500 text-sm mb-1">
          עד ההמראה •{" "}
          {TRIP_DATA.startDate.toLocaleDateString("he-IL", {
            day: "numeric",
            month: "numeric",
          })}
        </p>
      ...
      <h3 className="text-xl font-medium text-gray-700 mb-4 px-2">
        בקרוב נפתח להזמנה
      </h3>
          ...
          >
            ...
            <div className="text-right">
              <h4 className="text-xl font-medium text-gray-800">
                {dest.name}{" "}
                {dest.id === "tokyo2" && (
                  <span className="text-xs text-pink-400 ml-1">חזרה</span>
                )}
              </h4>
              <p className="text-gray-500 text-sm">{dest.nights} לילות</p>
            </div>
            <div
              className={`w-10 h-10 rounded-full ${dest.color} flex items-center justify-center text-white font-bold text-lg shadow-sm`}
            >
              {i + 1}
            </div>
          </div>
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-3xl font-light text-gray-800 text-right">
            לאן עכשיו?
          </h2>
          <p className="text-gray-500 text-sm">
            מתוכנן, אופציונלי, וכל מה ששמרנו
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {TRIP_DATA.categories.map((cat, i) => (
          <div
            key={i}
            className={`${cat.color} rounded-3xl p-5 flex flex-col items-center justify-center text-center shadow-sm h-40 relative overflow-hidden`}
          >
...
function ItineraryTab({ selectedDay, setSelectedDay }) {
  ...
  return (
    <div className="animate-in fade-in duration-500 h-full flex flex-col">
      ...
      <div
        className="flex gap-2 overflow-x-auto pb-4 mb-2 no-scrollbar px-2"
        dir="ltr"
      >
          ...
          >
            ...
            <span
              className={`text-lg font-bold ${
                selectedDay === i ? "text-white" : "text-gray-800"
              }`}
            >
              {day.date}
            </span>
      ...
      {/* Day Header */}
      <div
        className={`rounded-3xl p-6 text-center text-white mb-6 relative overflow-hidden ${dayData.color}`}
      >
        <div className="absolute top-0 left-0 w-full h-full bg-black/10"></div>
        <div className="relative z-10">
          <h2 className="text-3xl font-light mb-1">{dayData.city}</h2>
          <p className="text-white/80 text-sm">
            יום {dayData.day} מתוך {TRIP_DATA.itinerary.length} •{" "}
            {dayData.hotel}
          </p>
        </div>
      </div>
      ...
      <div className="relative border-r-2 border-dashed border-gray-300 pr-6 mr-2 pb-10">
        {dayData.events.map((ev, i) => (
          <div
            key={i}
            className="mb-6 relative animate-in slide-in-from-right-4 duration-300"
            style={{ animationDelay: `${i * 100}ms` }}
          >
            {/* Timeline Dot */}
            <div
              className={`absolute -right-[31px] top-4 w-4 h-4 rounded-full ${dayData.color} border-4 border-[#FDF8EE]`}
            ></div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 bg-white p-4 rounded-2xl shadow-sm border border-gray-50 relative">
                <div
                  className={`absolute top-0 right-0 w-1 h-full ${dayData.color} rounded-r-2xl`}
                ></div>
...
function MoreTab({ speakJapanese }) {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      ...
      <div className="mb-8">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-50 mb-3 relative overflow-hidden">
          ...
          <div className="flex justify-between items-center text-center relative">
            ...
            <Plane
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-blue-400 bg-white px-1"
              size={16}
            />
          ...
          {TRIP_DATA.dictionary.map((item, i) => (
            <div
              ...
              className={`flex items-center justify-between p-4 ${
                i !== TRIP_DATA.dictionary.length - 1
                  ? "border-b border-gray-100"
                  : ""
              } ${i % 2 === 0 ? "bg-[#F4F8FA]" : "bg-white"}`}
            >
              <button
      ...
      {/* Contacts Section */}
      <div>
        <h3 className="text-xl font-medium text-gray-700 mb-2 px-2">
          אנשי קשר חשובים 📞
        </h3>
