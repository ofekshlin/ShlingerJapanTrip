...
const TRIP_DATA = {
  ...
  // Real category/place data lives in places-data.js (imported as PLACE_CATEGORIES),
  // generated from the "Tokyo by Ptitim" Google My Maps export — 740 real places
  // across 10 categories (Izakaya, Ramen, sushi, cafes, shops, etc).
};
        ...
        <div className="space-y-3">
          {selectedCategory.places.map((place, i) => {
            const mapUrl = (place.lat != null && place.lng != null)
              ...
              : `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(place.name + ' Tokyo Japan')}`;
            return (
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">740 מקומות מהמפה של פתיתים</p>
        </div>
      </div>
